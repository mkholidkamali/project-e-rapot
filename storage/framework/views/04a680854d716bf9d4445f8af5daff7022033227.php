...
<?php $__env->startSection('main'); ?>
    ...
    <div class="card col-md-6">
        <div class="card-body">
            <form action="<?php echo e(route('siswa.update', $siswa->id)); ?>" method="post" class="" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="absen" id="absen" maxlength="2" value="<?php echo e($siswa->absen, old('absen')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="nis" id="nis" maxlength="8" value="<?php echo e($siswa->nis, old('nis')); ?>">
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="nisn" id="nisn" maxlength="10" value="<?php echo e($siswa->nisn, old('nisn')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="nama" id="nama" value="<?php echo e($siswa->nama, old('nama')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-2">
                    ...
                    <small class="text-muted">Sebelumnya : <?php echo e($siswa->kelas->kelas . ' - ' . strtoupper($siswa->kelas->jurusan)); ?></small>
                ...
                <div class="mb-2">
                    ...
                    <small class="text-muted">Sebelumnya : <?php echo e($siswa->jenis_kelamin='l' ? 'Laki-laki' : 'Perempuan'); ?></small>
                ...
                <div class="mb-2">
                    ...
                    <small class="text-muted">Sebelumnya : <?php echo e(strtoupper($siswa->agama)); ?></small>
...
<?php echo $__env->make('layouts.dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Project\TelkomSchool\projek-raport\resources\views/dashboard/siswa/edit.blade.php ENDPATH**/ ?>